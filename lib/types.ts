...
export type CaseStatus = "draft" | "under_review" | "changes_requested" | "quotation_issued" | "awaiting_deposit" | "installation_date_proposed" | "installation_scheduled" | "installed_monitoring" | "trial_review" | "active_installments" | "completed" | "cancelled";
...
export interface RejectPaymentInput { paymentId: ID; reason: string; }
