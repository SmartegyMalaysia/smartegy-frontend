...
export interface CreateCaseInput { customer: Pick<CustomerRecord, "displayName" | "contactName" | "email" | "phone">; service: Pick<ServiceRecord, "siteAddress" | "addressLine1" | "addressLine2" | "postcode" | "city" | "state" | "notes">; documents: CaseDocumentInput[]; }
