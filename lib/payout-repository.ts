import type { AgentMonthlyPayout, CurrentUser, PayoutMonthSummary, PayoutSettlementStatus, PayoutTransaction } from "./types";
...
export interface PayoutDirectoryQuery { search?: string; agentId?: string; settlementStatus?: PayoutSettlementStatus | AgentMonthlyPayout["settlementStatus"] | "all"; page?: number; pageSize?: number; sortBy?: "agent" | "date"; sortDirection?: "asc" | "desc"; view?: "agents" | "transactions"; }
export interface PayoutMonthData { summary: PayoutMonthSummary; agentPayouts: AgentMonthlyPayout[]; transactions: PayoutTransaction[]; totalItems?: number; totalPages?: number; }
export interface PayoutRepository { getMonth(actor: CurrentUser, payoutMonth: string, query?: PayoutDirectoryQuery): Promise<PayoutResult<PayoutMonthData>>; exportMonth(actor: CurrentUser, payoutMonth: string): Promise<PayoutResult<true>>; exportTransactions(actor: CurrentUser, payoutMonth: string, query?: PayoutDirectoryQuery): Promise<PayoutResult<true>>; settleTransaction(actor: CurrentUser, input: { transactionId: string; bankReference: string; payoutMonth?: string }): Promise<PayoutResult<PayoutTransaction>>; }

const initialTransactions: PayoutTransaction[] = [
  { id: "payout-001", payoutMonth: "2026-09", agentId: "agent-001", agentName: "Aisha Rahman", agentCode: "AG-001", bankAccount: { bankName: "Maybank", accountHolderName: "Aisha Rahman", accountNumberMasked: "•••• 4581" }, commissionId: "com-001", caseNumber: "SMG-00124", customerDisplayName: "Kencana Packaging Sdn Bhd", amountSen: 1760, commissionStatus: "approved", settlementStatus: "pending", settledAt: null, settledById: null, settledByDisplayName: null, bankReference: null },
  { id: "payout-002", payoutMonth: "2026-09", agentId: "agent-002", agentName: "Daniel Lim", agentCode: "AG-002", bankAccount: { bankName: "CIMB", accountHolderName: "Daniel Lim", accountNumberMasked: "•••• 9132" }, commissionId: "com-002", caseNumber: "SMG-00124", customerDisplayName: "Kencana Packaging Sdn Bhd", amountSen: 2782, commissionStatus: "approved", settlementStatus: "pending", settledAt: null, settledById: null, settledByDisplayName: null, bankReference: null },
  { id: "payout-003", payoutMonth: "2026-09", agentId: "agent-001", agentName: "Aisha Rahman", agentCode: "AG-001", bankAccount: { bankName: "Maybank", accountHolderName: "Aisha Rahman", accountNumberMasked: "•••• 4581" }, commissionId: "com-003", caseNumber: "SMG-00131", customerDisplayName: "Seri Maju Trading", amountSen: 2450, commissionStatus: "approved", settlementStatus: "pending", settledAt: null, settledById: null, settledByDisplayName: null, bankReference: null },
  { id: "payout-004", payoutMonth: "2026-09", agentId: "agent-004", agentName: "Hafiz Roslan", agentCode: "AG-004", bankAccount: { bankName: "Public Bank", accountHolderName: "Hafiz Roslan", accountNumberMasked: "•••• 6804" }, commissionId: "com-004", caseNumber: "SMG-00132", customerDisplayName: "Murni Engineering", amountSen: 3125, commissionStatus: "paid", settlementStatus: "settled", settledAt: "2026-09-16T09:20:00Z", settledById: "user-002", settledByDisplayName: "Farid Iskandar", bankReference: "PBK-SEP-00034" },
];
