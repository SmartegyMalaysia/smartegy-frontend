...
export default function UsersPage() {
  ...
  return <AppShell user={user} onRoleChange={setRole}><main className="page-content users-page">
    <div className="page-header"><div><p className="eyebrow">Administration</p><h1>Manage Users</h1><p className="page-description">Keep account access, roles, and contact details accurate across Smartegy.</p></div><div className="users-access-note"><Icon name="user-settings" size={16}/><span>Admin access only</span></div></div>
