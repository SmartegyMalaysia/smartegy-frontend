...
function SelectField({ id, label, value, onChange, options, required = false, optional = false }: { id: string; label: string; value: string; onChange: (value: string) => void; options: readonly string[]; required?: boolean; optional?: boolean }) { const fieldOptions = label === "State" ? malaysiaStates : options; return <FormField title={label} required={required}><FilterSelect allLabel={`Select ${label.toLowerCase()}`} value={value} options={[...fieldOptions]} onChange={onChange} /></FormField>; }
