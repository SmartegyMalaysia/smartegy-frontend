...
export function StaffInvitationPage() {
  ...
  if (state === "complete") return <AuthShell {...invitationIntro} kicker="Staff invitation" title="Account activated" description="Your staff account is ready to use."><div className="auth-success-panel" role="status"><span aria-hidden="true">✓</span><p>Your staff account is active. You can now sign in with the password you created.</p></div><Link className="login-submit auth-action-link" href="/">Return to sign in</Link></AuthShell>;
