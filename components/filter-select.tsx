...
export function FilterSelect<T extends string>({ id, allLabel, title, value, options, onChange, labels, disabled = false, ariaLabel, ariaInvalid = false, ariaDescribedBy, required = false }: { id?: string; allLabel: string; title?: string; value: T; options: T[]; onChange: (value: T) => void; labels?: Partial<Record<T, string>>; disabled?: boolean; ariaLabel?: string; ariaInvalid?: boolean; ariaDescribedBy?: string; required?: boolean }) {
