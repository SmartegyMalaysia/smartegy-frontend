...
import type { CaseDetail, CaseDocument, CasePayment, CurrentUser, PaymentSchedule } from "@/lib/types";
...
function downloadLabel(fileName: string, mimeType?: string) {
  ...
  if (mimeType === "application/vnd.openxmlformats-officedocument.wordprocessingml.document" || extension === "DOCX") return "Download DOCX";
  if (mimeType === "application/pdf" || extension === "PDF") return "Download PDF";
  if (mimeType === "image/jpeg" || extension === "JPG" || extension === "JPEG") return "Download JPG";
  if (mimeType === "image/png" || extension === "PNG") return "Download PNG";
  if (mimeType === "image/webp" || extension === "WEBP") return "Download WEBP";
